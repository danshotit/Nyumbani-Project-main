      ...
      >
        <div className="flex flex-col items-start h-auto justify-between gap-16 w-2/4 max-lg:w-full pr-10 max-sm:pr-0">
          <div className="flex flex-col text-lg items-start  justify-between gap-10 ">
            <a href="/">
              <img src="/Homyz-logo2.png" className="w-36" alt="" />
            </a>
            <p style={{ color: "#E1AD01" }}>
            "Your gateway to exceptional properties and unparalleled service. Find your dream home today with us."
            </p>
            <div className="flex text-xl justify-start items-center gap-10 text-yellow-500">
          ...
          <p style={{ color: "#696969" }}>© Quick Homes. All Rights Reserved 2024.</p>
        </div>
