    ...
    <div className=" w-full overflow-hidden">
          ...
          >
            ...
            >
              <div className="card-header text-2xl flex items-center gap-4">
                <div className="bg-yellow-500 w-[60px] h-[58px] rounded-md text-xl flex gap-4 justify-center items-center">
                  <FaEnvelope className="text-white" />
                </div>
                <h2 className="title-font font-semibold ">Services</h2>
              </div>
              <p>Unlock a world of tailored real estate solutions. Our services, your peace of mind.</p>
            </motion.div>
            <motion.div
              variants={animationVariants.fadeUp}
              className="card bg-white text-black rounded-md gap-5  p-6 pb-10 max-lg:p-5 max-lg:pb-8 max-md:p-6 max-md:py-7 max-md:pb-10 flex flex-col gap text-xl "
            >
              ...
              <p>Transparent pricing tailored to your needs. Discover fair and competitive rates for your ideal property.</p>
            </motion.div>
            <motion.div
              variants={animationVariants.fadeUp}
              className="card bg-white text-black rounded-md gap-5  p-6 pb-10 max-lg:p-5 max-lg:pb-8 max-md:p-6 max-md:py-7 max-md:pb-10 flex flex-col gap text-xl "
            >
              ...
              <p>24/7 support at your fingertips. Our dedicated team is here to assist you every step of the way.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      >
        ...
        >
          ...
          <p className="text-xl">
          "Explore our platform today and discover your next dream property. Visit us now to embark on your real estate journey!"
          </p>
          <div className="flex flex-col gap-3">
            ...
            <div className="flex  gap-3 text-xl items-center">
              ...
              <p>information@quickhomes.co.ke</p>
            </div>
          </div>
        </motion.div>
      </div>
          ...
          <div className="relative">
            ...
            <div className="absolute flex justify-center items-center  bg-white/90  top-0 left-0 right-0 bottom-0">
              ...
              >
                ...
                "Your gateway to exceptional properties and unparalleled service. Find your dream home today with us."
                </p>
              </motion.div>
            </div>
          ...
          >
            ...
            <Link to="/about" onClick={scrollToTop}>
              <button
                ...
                className="bg-transparent  text-black border-yellow-500 text-xl px-5 py-2 duration-300 hover:bg-red-500 hover:text-white transition-all mt-5 max-md:mt-3"
              >
                About Us
              </button>
            </Link>
