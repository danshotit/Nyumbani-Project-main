    ...
    <div className=" w-full overflow-hidden">
      <div className="  flex bg-[url('/hero-bg-image.jpg')] pt-36 pb-20 bg-top bg-no-repeat bg-cover  ">
        ...
        >
          ...
          >
            <FaPeriscope className="text-yellow-500 text-2xl absolute left-2 top-5 " />
            <input
              placeholder="Search..."
              onKeyDown={(e) => {
                if (e.key === "Enter") {
          ...
          <div className="w-2/4 max-md:w-full ">
            ...
            >
              <h2 className="text-5xl max-md:text-4xl font-bold title-font">
                ...
                <span className=" text-yellow-500 title-font "> since 2024</span>
              </h2>
            </motion.div>
          </div>
          <div className="w-2/4 max-md:w-full">
            ...
            >
              <p className="text-xl">
              Demonstrating a commitment to sustainability and environmental responsibility, such as promoting energy-efficient properties
               or green building practices, resonates with users who value eco-friendly options.
              </p>
      ...
      <div className="bg-gray-100">
        ...
        >
          ...
          >
            ...
            <p className="text-xl">
              We offerRental Properties, Commercial spaces, Vacation Rentals and Land for development.
            ...
            <Link onClick={scrollToTop} to={"/about"}>
              <button
                ...
                className="bg-transparent  text-black border-yellow-500 text-xl px-5 py-2 duration-300 hover:bg-yellow-500 hover:text-white transition-all mt-5 max-md:mt-3"
              >
                About Us
              </button>
            </Link>
          ...
          >
            <div className="flex flex-col gap-7 ">
              <WhatWeDoCard
                ...
                title={"Reliability"}
                desc={
                  "Dependable. Trustworthy. Your reliable partner in real estate."                }
              />
              <WhatWeDoCard
                ...
                title={"communication"}
                desc={
                  "Open lines, clear connections. Communicating seamlessly for your peace of mind."
                }
              />
            </div>
            <div className="flex flex-col gap-7">
              ...
              <WhatWeDoCard
                ...
                title={"Quality First"}
                desc={
                  "Quality first, always. Elevating your real estate experience with unparalleled standards."
                }
              />
              <div
                style={{ height: 130 }}
      ...
      <div className="bg-white">
        ...
        >
          ...
          >
            ...
            >
              We use Real Estate to show our appreciation and possibilities of the world.
            </motion.h1>
            ...
            >
              <div className="flex flex-col max-lg:justify-center max-lg:items-center">
                <h2 className="title-font text-yellow-500 text-5xl max-md:text-4xl font-semibold">
                  1
                </h2>
                <p className="text-xl">
                  Years of successful experience in real estate
                </p>
              </div>
