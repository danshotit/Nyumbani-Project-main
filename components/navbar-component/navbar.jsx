...
const NavBar = ({ navBar2, showCase1Page }) => {
  ...
  const [logo, setlogo] = useState("/Homyz-logo2.png");
              ...
              <div>
                ...
                <div className="p-6 pt-0 bg-white max-sm:pt-6 flex max-sm:fixed bottom-0 left-0 right-0 flex-col gap-5">
                  <div className="flex justify-between items-center">
                    <h2>Subtotal</h2>
                    <p className="total text-yellow-500">
          ...
          >
            ...
            >
              {totalQty > 0 ? (
                ...
                <p
                  className={`absolute bg-yellow-500 pt-[1.5px] text-white rounded-full h-[18px] px-1   min-w-[18px] ${
        ...
        <ul className="flex flex-col gap-3 mt-8 text-xl ">
          ...
          <div className="relative">
            <div
              ...
              className="flex justify-between hover:text-yellow-500 max-sm:hover:text-black transition-all items-center cursor-pointer"
            >
            ...
            >
              <Link
                ...
                to={"/about"}
                className="hover:text-yellow-500 transition-all w-full block"
              >
                About
              </Link>
              <Link
